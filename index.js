...
for (const folder of commandFolders) {
    ...
    // ===== TEMPORARY SPECIAL FILE SEARCHING =====
...
client.once('ready', () => {
    console.log('Ready!');
    client.user.setActivity(`dev credits`, {
        type: "WATCHING",
    });
});
...
client.on('messageCreate', message => {
    // === All the auto responders ==
    if (message.content.toLowerCase() === 'hi')
        return message.reply('Hi :D');

    if (message.content.toLowerCase() === 'rickroll')
        return message.reply('https://c.tenor.com/o656qFKDzeUAAAAM/rick-astley-never-gonna-give-you-up.gif')
